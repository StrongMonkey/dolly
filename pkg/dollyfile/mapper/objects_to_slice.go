...
func NewObjectsToSliceFactory(newObject StringerFactory, object ToObject) s.FieldMapperFactory {
	return func(field string, _ ...string) s.Mapper {
...
func (p ObjectsToSlice) ModifySchema(schema *s.Schema, schemas *s.Schemas) error {
	return mappers.ValidateField(p.Field, schema)
}
