...
func containers(service types.Service, init bool) (result []v1.Container) {
	for _, container := range utils.ToNamedContainers(service) {
...
func toContainer(containerName string, c *types.Container) v1.Container {
	con := v1.Container{
		Image:           c.Image,
		Command:         c.Command,
		Args:            c.Args,
...
func securityContext(c *types.Container) *v1.SecurityContext {
...
func mounts(containerName string, c *types.Container) (result []v1.VolumeMount) {
...
func dataMounts(def, name string, dataMounts []types.DataMount) (result []v1.VolumeMount) {
	readonly := false
	if name == "secret" {
		readonly = true
	}
...
func normalizeVolumes(containerName string, volumes []types.Volume) (result []types.Volume) {
...
func volumeMount(containerName string, volumes []types.Volume) (result []v1.VolumeMount) {
...
func envs(containerName string, c *types.Container) (result []v1.EnvVar) {
...
func ports(c *types.Container) (result []v1.ContainerPort) {
...
func resources(c *types.Container) (result v1.ResourceRequirements) {
